...
uses
  ...
  ComCtrls, Grids, DBGrids, ExtCtrls, Db, InstantPresentation, Buttons,
  StdCtrls, ActnList, ToolWin, ImgList, Model, Menus, BasicView,
  InstantExplorer;
...
uses
  Utility, BasicEdit, InstantClasses, InstantPersistence, ShellApi,
