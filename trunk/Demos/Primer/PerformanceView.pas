...
uses
  ...
  ExtCtrls, StdCtrls, Contnrs, InstantPersistence, InstantPresentation,
  InstantClasses, Stopwatch, Db, TeEngine, Series, TeeProcs, Chart, ComCtrls,
  ToolWin, Menus, BasicView;
...
type
  ...
  TPerformanceViewForm = class(TBasicViewForm)
    ...
    procedure TestResultListViewEdited(Sender: TObject; Item: TListItem;
      var S: String);
...
procedure TPerformanceViewForm.TestResultListViewEdited(Sender: TObject;
