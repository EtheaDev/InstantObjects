 ...
 *
 * ***** END LICENSE BLOCK ***** *)
unit InstantObjects.WiRL.Server.Exceptions;
...
constructor EWiRLServerException.CreateError(const AErrorCode: THttpStatusCode;
...
function EWiRLServerException.GetErrorJSONContent: string;
begin
  Result := ComposeErrorJSONContent(ErrorCode, self.Description, self.FieldName);
end;

class function EWiRLServerException.ComposeErrorJSONContent(
