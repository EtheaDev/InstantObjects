 ...
 *
 * ***** END LICENSE BLOCK ***** *)
unit InstantObjects.WiRL.Server.Resources.Base;
...
type
  // Base class for all WiRL Server resources. Provides basic services and utilities,
...
var
  LDebugOutput: string;
begin
  LDebugOutput := Request.Headers['debug_output'];
  Result := LDebugOutput <> '';
end;
...
//  TWiRLResourceRegistry.Instance.RegisterResource<TOpenAPIResource>;
